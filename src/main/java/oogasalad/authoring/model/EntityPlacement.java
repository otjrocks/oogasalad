...
/**
 * Represents the placement of an entity on the game canvas.
 * Stores both the entity data and its position coordinates.
 */
public class EntityPlacement {
    ...
    /**
     * Updates the initial position in the EntityData to match
     * the current placement coordinates.
     */
