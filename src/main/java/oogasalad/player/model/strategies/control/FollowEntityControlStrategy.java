...
public class FollowEntityControlStrategy implements ControlStrategyInterface {
   ...
   */
  public FollowEntityControlStrategy(GameMapInterface gameMap, EntityPlacement placement,
  ...
  public void update(Entity entity) {
    ...
    double[] targetPos = {targetEntity.getEntityPlacement().getX(),
        targetEntity.getEntityPlacement().getY()};
