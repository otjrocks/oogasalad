...
/**
 * A collision strategy that teleports an entity from one portal to its partner portal.
 * When an entity collides with a portal, this strategy finds another portal of the
 * matching type and teleports the entity to that location.
 *
...
public class TeleportToPartnerPortalStrategy implements CollisionStrategyInterface {
     ...
     */
    public TeleportToPartnerPortalStrategy(String portalType, String partnerType, boolean randomPartner,
