...
/**
 * An exception thrown by the BFSEntity If something fails
 *
 * @author Jessica Chen
 */
public class BfsEntityException extends RuntimeException {
   ...
   */
  public BfsEntityException(String message) {
    super(message);
  }
   ...
   *              triggered this one.
   */
  public BfsEntityException(String message, Throwable cause) {
    super(message, cause);
  }
}
